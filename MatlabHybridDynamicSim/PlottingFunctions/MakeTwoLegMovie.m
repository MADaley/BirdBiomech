function [centerMovie, handle] = MakeTwoLegMovie(bodyStates, footStates, params)
...
for timeIndex = 1:length(timeIndices),
    ...
    hold off;
	plotSpring([bodyStates(1, i) bodyStates(2, i)], [footStates(1, i) footStates(2, i)],  Lnot*0.15,'b');
    %plot([allx_resampled(i) allFootStatesX_resampled(i)], [ally_resampled(i) allFootStatesY_resampled(i)]);
    hold on;
   plotSpring([bodyStates(1, i) bodyStates(2, i)], [footStates(3, i) footStates(4, i)],  Lnot*0.15,'r');
